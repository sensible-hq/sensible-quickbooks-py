...
Extracts data from a vendor invoice PDF using Sensible, then creates a bill in QuickBooks Online. For the full tutorial, including prerequisites for your Sensible account, see [Integrate with Quickbooks using Python](https://docs.sensible.so/docs/).
